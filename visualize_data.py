...
def plotCyberH(file):
    ...
    ax1.plot(mcf1, label="mcf1")
    ax1.plot(ifd1, label="ifd1")
    ax1.plot(a1, label="a1")
    ax1.legend(loc=4)

    ax2.plot(mcf2, label="mcf2")
    ax2.plot(ifp2, label="ifp2")
    ax2.plot(a2, label="a2")
    ax2.legend(loc=4)

    ax3.plot(mcf3, label="mcf3")
    ax3.plot(ifd3, label="ifd3")
    ax3.plot(ifp3, label="ifp3")
    ax3.plot(a3, label="a3")
    ax3.legend(loc=4)

    ax4.plot(mcf4, label="mcf4")
    ax4.plot(ifd4, label="ifd4")
    ax4.plot(ifp4, label="ifp4")
    ax4.plot(a4, label="a4")
    ax4.legend(loc=4)

    ax5.plot(mcf5, label="mcf5")
    ax5.plot(ifd5, label="ifd5")
    ax5.plot(ifp5, label="ifp5")
    ax5.plot(a5, label="a5")
    ax5.legend(loc=4)

    ax6.plot(roll1, label="roll1")
    ax6.plot(roll5, label="roll5")
    ax6.plot(c, label="c")
    ax6.plot(c_ano, label="c_ano")
    ax6.plot(usado, label="usado")
    ax6.legend(loc=4)
